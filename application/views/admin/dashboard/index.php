                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Available Banks</span>
                                    <span class="info-box-number"><?php echo $count_paybankfs; ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Pay Analysis</span>
                                    <span class="info-box-number"><?php echo $count_payanalfs; ?></span>
                                </div>
                            </div>
                        </div>
